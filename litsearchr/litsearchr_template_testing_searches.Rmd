...
title_search <- litsearchr::write_title_search(titles=gold_standard$Title)
...
```{r}
title_search <- litsearchr::import_scope(directory="./title_hits/", 
...
```{r}
my_search <- litsearchr::import_scope(directory="./search_hits/", remove_duplicates=TRUE, clean_dataset=FALSE)
